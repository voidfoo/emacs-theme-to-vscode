...
3. Type `ext install emacs-themes` to find the extension
4. Click Install
...
3. Choose one of the Emacs themes from the list
...
- [Ef (εὖ) Themes](https://github.com/protesilaos/ef-themes)

## Contributing

Found a bug or want to contribute? Visit our [GitHub repository](https://github.com/voidfoo/emacs-theme-to-vscode).
