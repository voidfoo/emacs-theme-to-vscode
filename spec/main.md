...
- Then it update existing themes under `/vscode-extension/themes` and copy any new themes there too.
- For newly copied themes it update Visual Studio Code extension's package.json to register them as well.
